...
public class view_Customer extends JFrame {
    ...
    public void get_get_Cust_Record()
    {
        ...
        try
        {
            ...
            while(m.next())
            {
                ...
                model.addRow(new Object[]{id,name,mail,mobile,gender});
            }
        } catch (ClassNotFoundException e) {
            throw new RuntimeException(e);
        } catch (SQLException e) {
    ...
    public view_Customer() {
        ...
        JLabel title_Label = new JLabel("Customer Report");
        title_Label.setFont(new Font("Tahoma", Font.BOLD, 16));
        title_Label.setBounds(343, 11, 153, 23);
        contentPane.add(title_Label);
        model = new DefaultTableModel();
        Object [] coloumn = {"ID","Name","Email","Contact","Gender"};
        ...
        JLabel total_Label = new JLabel("Total Customers");
